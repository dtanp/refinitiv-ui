...
| `--include-snapshots` | Run test and include snapshots. The option is use by default, you can close by set this option to `false`.<br>Usage:`npm run test button -- --include-snapshots=<boolean>` |
| `--include-coverage` | Run test and include coverage. The option is use by default, you can close by set this option to `false`.<br>Usage:`npm run test button -- --include-coverage=<boolean>` |
